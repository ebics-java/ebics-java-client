 ...
 */
class EbicsDownloadOrder(adminOrderType: EbicsAdminOrderType, val orderType: String?, startDate: Date?, endDate: Date?, params: Map<String, String>) : AbstractEbicsDownloadOrder(
        adminOrderType,
        startDate,
        endDate,
        params
