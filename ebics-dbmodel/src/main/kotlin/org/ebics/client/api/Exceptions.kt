 ...
 */
class NotFoundException(val id:String, private val objectName: String, ex: Exception?) :
    RuntimeException("Can't find $objectName id='$id'", ex) {
        constructor(id:Long, objectName: String, ex: Exception?) : this(id.toString(), objectName, ex)
    }
