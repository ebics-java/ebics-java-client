...
import org.ebics.schema.h005.PubKeyValueType;
...
public class HIARequestOrderDataElement extends DefaultEbicsRootElement {
  ...
  public void build() throws EbicsException {
    ...
    encryptionPubKeyValue = EbicsXmlFactory.createh005PubKeyValueType(encryptionRsaKeyValue, Calendar.getInstance());
    ...
    authPubKeyValue = EbicsXmlFactory.createh005PubKeyValueType(AuthRsaKeyValue, Calendar.getInstance());
