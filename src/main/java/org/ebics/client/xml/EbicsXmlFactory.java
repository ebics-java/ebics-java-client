...
import org.ebics.schema.h003.EbicsNoPubKeyDigestsRequestDocument.EbicsNoPubKeyDigestsRequest;
...
import org.ebics.schema.h003.EbicsUnsecuredRequestDocument;
...
import org.ebics.schema.h003.FDLOrderParamsDocument;
import org.ebics.schema.h003.FDLOrderParamsType;
import org.ebics.schema.h003.FDLOrderParamsType.DateRange;
import org.ebics.schema.h003.FULOrderParamsDocument;
import org.ebics.schema.h003.FULOrderParamsType;
import org.ebics.schema.h003.FileFormatType;
import org.ebics.schema.h003.HIARequestOrderDataDocument;
...
import org.ebics.schema.h003.NoPubKeyDigestsRequestStaticHeaderType;
...
import org.ebics.schema.h003.StandardOrderParamsDocument;
...
import org.ebics.schema.h003.TransactionPhaseType.Enum;
...
import org.ebics.schema.s001.SignaturePubKeyOrderDataDocument;
import org.ebics.schema.s001.SignaturePubKeyOrderDataType;
import org.ebics.schema.s001.UserSignatureDataDocument;
...
import org.ebics.schema.xmldsig.SignatureMethodType;
import org.ebics.schema.xmldsig.SignatureType;
import org.ebics.schema.xmldsig.SignatureValueType;
import org.ebics.schema.xmldsig.SignedInfoDocument;
import org.ebics.schema.xmldsig.SignedInfoType;
import org.ebics.schema.xmldsig.TransformType;
import org.ebics.schema.xmldsig.TransformsType;
...
public class EbicsXmlFactory {
   ...
   * @param pubKeyValue the <code>org.ebics.schema.h003.PubKeyValueType</code> element
   * @param x509Data the <code>X509DataType</code> element
  ...
  public static AuthenticationPubKeyInfoType createAuthenticationPubKeyInfoType(String authenticationVersion,
                                                                                org.ebics.schema.h003.PubKeyValueType pubKeyValue,
  ...
  /**
   * Creates a new <code>org.ebics.schema.h003.PubKeyValueType</code> XML object
   * @param rsaKeyValue the <code>RSAKeyValueType</code> element
   * @param timeStamp the current time stamp
   * @return the <code>org.ebics.schema.h003.PubKeyValueType</code> XML object
   */
  public static org.ebics.schema.h003.PubKeyValueType createH003PubKeyValueType(RSAKeyValueType rsaKeyValue, Calendar timeStamp) {
    org.ebics.schema.h003.PubKeyValueType newPubKeyValueType = org.ebics.schema.h003.PubKeyValueType.Factory.newInstance();
    newPubKeyValueType.setRSAKeyValue(rsaKeyValue);
    newPubKeyValueType.setTimeStamp(timeStamp);
  ...
  /**
   * Creates a new <code>org.ebics.schema.h003.EbicsNoPubKeyDigestsRequestDocument.EbicsNoPubKeyDigestsRequest.Header</code> XML object
   * @param authenticate should authenticate?
   * @param mutable the <code>EmptyMutableHeaderType</code> element
   * @param xstatic the <code>NoPubKeyDigestsRequestStaticHeaderType</code> element
   * @return the <code>org.ebics.schema.h003.EbicsNoPubKeyDigestsRequestDocument.EbicsNoPubKeyDigestsRequest.Header</code> XML object
   */
  public static org.ebics.schema.h003.EbicsNoPubKeyDigestsRequestDocument.EbicsNoPubKeyDigestsRequest.Header createDigestsRequestHeader(boolean authenticate,
                                                                                                                                           EmptyMutableHeaderType mutable,
                                                                                                                                           NoPubKeyDigestsRequestStaticHeaderType xstatic)
  {
    org.ebics.schema.h003.EbicsNoPubKeyDigestsRequestDocument.EbicsNoPubKeyDigestsRequest.Header newHeader = org.ebics.schema.h003.EbicsNoPubKeyDigestsRequestDocument.EbicsNoPubKeyDigestsRequest.Header.Factory.newInstance();
    newHeader.setAuthenticate(authenticate);
    newHeader.setMutable(mutable);
    newHeader.setStatic(xstatic);
  ...
  /**
   * Creates a new <code>org.ebics.schema.h003.EbicsNoPubKeyDigestsRequestDocument.EbicsNoPubKeyDigestsRequest.Body</code> XML object
   * @return the <code>org.ebics.schema.h003.EbicsNoPubKeyDigestsRequestDocument.EbicsNoPubKeyDigestsRequest.Body</code> XML object
   */
  public static org.ebics.schema.h003.EbicsNoPubKeyDigestsRequestDocument.EbicsNoPubKeyDigestsRequest.Body createDigestsRequestBody() {
    org.ebics.schema.h003.EbicsNoPubKeyDigestsRequestDocument.EbicsNoPubKeyDigestsRequest.Body newBody = org.ebics.schema.h003.EbicsNoPubKeyDigestsRequestDocument.EbicsNoPubKeyDigestsRequest.Body.Factory.newInstance();
  ...
  /**
   * Creates a new <code>org.ebics.schema.h003.EbicsRequestDocument.EbicsRequest.Header</code> XML object
   * @param authenticate should authenticate?
   * @param mutable the <code>MutableHeaderType</code> element
   * @param xstatic the <code>StaticHeaderType</code> element
   * @return the <code>org.ebics.schema.h003.EbicsRequestDocument.EbicsRequest.Header</code> XML object
   */
  public static org.ebics.schema.h003.EbicsRequestDocument.EbicsRequest.Header createEbicsRequestHeader(boolean authenticate,
                                                                                                           MutableHeaderType mutable,
                                                                                                           StaticHeaderType xstatic)
  {
    org.ebics.schema.h003.EbicsRequestDocument.EbicsRequest.Header newHeader = org.ebics.schema.h003.EbicsRequestDocument.EbicsRequest.Header.Factory.newInstance();
    newHeader.setAuthenticate(authenticate);
    newHeader.setMutable(mutable);
    newHeader.setStatic(xstatic);
  ...
  /**
   * Create the <code>org.ebics.schema.h003.EbicsRequestDocument.EbicsRequest.Body</code> XML object
   * @param dataTransfer the <code>DataTransferRequestType</code> element
   * @return the <code>org.ebics.schema.h003.EbicsRequestDocument.EbicsRequest.Body</code> XML object
   */
  public static org.ebics.schema.h003.EbicsRequestDocument.EbicsRequest.Body createEbicsRequestBody(DataTransferRequestType dataTransfer) {
    org.ebics.schema.h003.EbicsRequestDocument.EbicsRequest.Body newBody = org.ebics.schema.h003.EbicsRequestDocument.EbicsRequest.Body.Factory.newInstance();
    newBody.setDataTransfer(dataTransfer);
   ...
   * @return the <code>org.ebics.schema.h003.EbicsRequestDocument.EbicsRequest.Body</code> XML object
   */
  public static org.ebics.schema.h003.EbicsRequestDocument.EbicsRequest.Body createEbicsRequestBody() {
    org.ebics.schema.h003.EbicsRequestDocument.EbicsRequest.Body newBody = org.ebics.schema.h003.EbicsRequestDocument.EbicsRequest.Body.Factory.newInstance();
   ...
   * @return the <code>org.ebics.schema.h003.EbicsRequestDocument.EbicsRequest.Body</code> XML object
   */
  public static org.ebics.schema.h003.EbicsRequestDocument.EbicsRequest.Body createEbicsRequestBody(TransferReceipt transferReceipt) {
    org.ebics.schema.h003.EbicsRequestDocument.EbicsRequest.Body newBody = org.ebics.schema.h003.EbicsRequestDocument.EbicsRequest.Body.Factory.newInstance();
  ...
  /**
   * Create the <code>DataTransferRequestType</code> XML object
   * @param orderData the <code>org.ebics.schema.h003.DataTransferRequestType.OrderData</code> element
   * @return the <code>DataTransferRequestType</code> XML object
   */
  public static DataTransferRequestType createDataTransferRequestType(org.ebics.schema.h003.DataTransferRequestType.OrderData orderData) {
    DataTransferRequestType newDataTransferRequestType = DataTransferRequestType.Factory.newInstance();
  ...
  /**
   * Create the <code>org.ebics.schema.h003.DataTransferRequestType.OrderData</code> XML object
   * @param orderDataValue the order data value
   * @return the <code>org.ebics.schema.h003.DataTransferRequestType.OrderData</code> XML object
   */
  public static org.ebics.schema.h003.DataTransferRequestType.OrderData createTransferRequestTypeOrderData(byte[] orderDataValue) {
    org.ebics.schema.h003.DataTransferRequestType.OrderData newOrderData = org.ebics.schema.h003.DataTransferRequestType.OrderData.Factory.newInstance();
   ...
   * @return the the <code>org.ebics.schema.h003.DataTransferRequestType.OrderData</code> XML object
   */
  public static org.ebics.schema.h003.DataTransferRequestType.OrderData createEbicsRequestOrderData(byte[] oderData) {
    org.ebics.schema.h003.DataTransferRequestType.OrderData newOrderData = org.ebics.schema.h003.DataTransferRequestType.OrderData.Factory.newInstance();
